!**********************************************************************************************************************!
!Main program file for converting a DLPOLY CONFIG file to coordinates-only format.                                     !
!**********************************************************************************************************************!
program DlpolyExtractConfigCoordinates
  ...
  procname = 'DlpolyExtractConfigCoordinates::DlpolyExtractConfigCoordinates'
  ...
  subroutine ParseCommandLine (file, kfrm, lhead, lpbc)
    ...
    procname = 'DlpolyExtractConfigCoordinates::ParseCommandLine'
    if (ltrace) call PrintTrace()
  ...
  subroutine PrintHelp (ekey)
    ...
    procname = 'DlpolyExtractConfigCoordinates::PrintHelp'
    if (ltrace) call PrintTrace()
    ...
    nn = 0
    nn = nn + 1 ; msgs(nn) = '                                                                                '
    nn = nn + 1 ; msgs(nn) = '**********         PROGRAM: DLPOLY-EXTRACT-CONFIG-COORDINATES         **********'
    nn = nn + 1 ; msgs(nn) = '                                                                                '
    nn = nn + 1 ; msgs(nn) = 'This program converts a DLPOLY CONFIG file to coordinates-only format.          '
    nn = nn + 1 ; msgs(nn) = '                                                                                '
    nn = nn + 1 ; msgs(nn) = 'USAGE: dlpoly-extract-config-coordinates -fhkps                                 '
    nn = nn + 1 ; msgs(nn) = '                                                                                '
...
end program DlpolyExtractConfigCoordinates
!**********************************************************************************************************************!
